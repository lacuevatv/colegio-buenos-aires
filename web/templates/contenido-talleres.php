...
$talleres = array(
	...
	'secundario' => array(
		...
		'content' => array(
			'El taller Preuniversitario tiene como fin la articulación con la Educación media a través del dictado de la asignatura “Introducción al Conocimiento de la Sociedad y el Estado”, correspondiente al curso de UBA XXI (Universidad de Buenos Aires). Permite facilitar el pasaje del nivel medio a los estudios superiores, como así también la interrelación con otras Universidades, tanto públicas como privadas. A través de este taller se le brinda a los futuros egresados toda la información concerniente a las carreras y proyectos educativos, como así también talleres de orientación vocacional para aquellos alumnos que tengan dudas acerca de la carrera que deseen seguir.',
			'Se trata de un taller eminentemente práctico, destinado a aquellos alumnos con inquietudes periodísticas, para que aprendan las técnicas de la información y adquieran las habilidades que les permitirán -en un futuro cercano- desempeñarse en los medios de comunicación. A través de nuestra revista Edad Feliz, los alumnos ya comienzan a publicar sus primeros reportajes, notas y fotografías, así como también comics y todo lo relacionado al mundo de la expresión. Además, a través de debates, análisis de películas, programas, noticias y publicidad, los educandos desarrollan el juicio crítico que los forma no sólo como emisores, sino también como receptores de la información, tan manipulada en la actualidad.',
